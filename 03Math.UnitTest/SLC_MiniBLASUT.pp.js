...
const fname_c = "SLC_MiniBLASUT.c"; // Output C source file
const fname_cin = "SLC_MiniBLASUT.cin"; // Input C source template file
const fname_cinfooter = "SLC_MiniBLASUTfoot.cin";
