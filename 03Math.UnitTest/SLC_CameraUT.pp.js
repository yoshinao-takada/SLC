...
const fname_c = "SLC_CameraUT.c"; // Output C source file
const fname_cin = "SLC_CameraUT.cin"; // Input C source template file
const fname_cinfooter = "SLC_CameraUTfoot.cin";
