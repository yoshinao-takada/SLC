...
const fname_c = "SLC_NLSLGNUT.c"; // Output C source file
const fname_cin = "SLC_NLSLGNUT.cin"; // Input C source template file
const fname_cinfooter = "SLC_NLSLGNUTfoot.cin";
