...
const fname_c = "SLC_NumbersCopyUT.c"; // Output C source file
const fname_cin = "SLC_NumbersCopyUT.cin"; // Input C source template file
const fname_cinfooter = "SLC_NumbersCopyUTfoot.cin";
